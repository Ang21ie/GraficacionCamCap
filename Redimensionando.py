...
# Cargamos las imagenes de la carpeta:
path = 'C:\Users\Nancy\PycharmProjects\pythonProject\CamAngie\imagen'
# Guardamos las imagenes en p(positivo):
path2 = 'C:\Users\Nancy\PycharmProjects\pythonProject\CamAngie\imagen\p'
